    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4 mt-6 justify-center">
        <button
          ...
          onClick={() =>
            generateMontecarloPDF({ rows: results.rows, params, results })
          }
        >
          Generar PDF
        </button>
